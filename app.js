...
var DATA = {
  days: [
    ...
    { id:4, color:"#26617F", theme:"자유시간 · 오로라 재도전", date:"9/13 (일)", iso:"2026-09-13", stops:[
      ...
      { t:"15:45", name:"Akkeri við Nýjabæjarvör (Seltjarnarnes 해안)", lat:64.160321, lng:-22.003841, cat:"관광", move:"🚌 11번 버스 약 30분 (카드 만료 → 편도 690 ISK)", note:"무료 · 북서쪽으로 트인 해안, 맑으면 Snæfellsjökull 빙하 보임 · Grótta 등대도 1.5km 거리라 멀리서 보임 · 둑길 안 건너니 물때 무관 · 바람 강하니 방한" },
      { t:"17:15", name:"숙소 복귀", lat:64.1437875, lng:-21.9126406, cat:"이동", move:"🚌 11번 버스 (690 ISK)" },
