...
var DATA = {
  days: [
    ...
    { id:6, color:"#1F5AA8", theme:"헬싱키", date:"9/15 (화)", iso:"2026-09-15", stops:[
      ...
      { t:"12:00", name:"점심 — Hakaniemi Market Hall", lat:60.180098, lng:24.951342, cat:"식사", move:"🚋 트램 5분 (AB권)", note:"화요일 8:00~18:00 · 연어수프 · 관광지스럽지 않고 현지인 많음" },
      { alt:true, t:"", name:"Café Aalto", lat:60.168106, lng:24.943655, cat:"카페", note:"화요일 9:00~20:00 · Aalto 설계 서점 2층 · 연어키슈·사과파이" },
      { alt:true, t:"", name:"Kiasma 내부 카페", lat:60.171591, lng:24.936864, cat:"카페", note:"이동 0분 · 다음 일정이 Kiasma라 제일 편함" },
      ...
      { t:"19:00", name:"저녁 — Restaurant BLINIt", lat:60.187901, lng:24.945057, cat:"식사", move:"도보 8분", note:"매일 12:00~22:00 · 블리니·보르시 · 대안: Saigon Bistro(Kaarlenkatu 13, 평점 4.9, ~20시 마감)" }
    ]},
