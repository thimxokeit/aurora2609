...
var DATA = {
  days: [
    ...
    { id:6, color:"#1F5AA8", theme:"헬싱키", date:"9/15 (화)", iso:"2026-09-15", stops:[
      ...
      { t:"11:45", name:"점심 — Kosmos", lat:60.168003, lng:24.939650, cat:"식사", move:"🚋 트램 5분 또는 도보 10분", note:"화요일 11:30~24:00 · 1924년부터 · 아르데코 인테리어, 예술가 단골집 · 순록·블리니·랍스터수프 · 예약 권장" },
      { alt:true, t:"", name:"Savoy", lat:60.166977, lng:24.947335, cat:"식사", note:"화요일 점심 11:30~16:00 · Alvar Aalto가 1937년 설계한 인테리어 그대로 · 파인다이닝이라 가장 비쌈 · 예약 필수" },
      { alt:true, t:"", name:"Restaurant Elite", lat:60.176569, lng:24.922915, cat:"식사", note:"화요일 12:00~22:00 · 1932년 예술가 레스토랑 · Oodi에서 서쪽 도보 15분" },
      { alt:true, t:"", name:"Hakaniemi Market Hall", lat:60.180098, lng:24.951342, cat:"식사", note:"화요일 8:00~18:00 · 연어수프 · 가볍고 저렴하게 먹고 싶을 때" },
      { t:"13:00", name:"Kiasma 컨템포러리 아트뮤지엄", lat:60.171591, lng:24.936864, cat:"관광", move:"도보 3분", note:"화요일 10:00~20:00 · 월요일 휴관" },
      { t:"15:00", name:"Design District 쇼핑", lat:60.160609, lng:24.946688, cat:"쇼핑", move:"🚋 트램 10분 또는 도보 18분", note:"매장 대부분 ~18시" },
    ...
    { id:7, color:"#4E6E8A", theme:"헬싱키 → 한국", date:"9/16 (수)", iso:"2026-09-16", stops:[
      ...
      { alt:true, t:"", name:"우스펜스키 성당", lat:60.168602, lng:24.959897, cat:"관광", note:"수요일 9:30~16:00 · 도보 15분 · 언덕 위라 항구 전망 좋음" },
      { alt:true, t:"", name:"건축·디자인 박물관", lat:60.163032, lng:24.946391, cat:"관광", note:"수요일 11:00~18:00 · 숙소서 도보 3분 · 무민 전시 있음 · 단 11시 개관이라 1시간만 가능" },
