...
var DATA = {
  days: [
    { id:1, color:"#173355", theme:"레이캬비크 도착", date:"9/10 (목)", iso:"2026-09-10", stops:[
      ...
      { t:"19:30", name:"숙소에서 휴식 (오로라 투어 취소됨)", lat:64.1437875, lng:-21.9126406, cat:"이동", note:"악천후로 취소 · 무료 재예약 진행 → Day4로 이동 · 만약 안 쉬었다면: Café Loki(Lokastígur 28, 매일 8-22, 도보 5분, 램수프 추천)에서 저녁 좋았을 듯" }
    ]},
    ...
    { id:3, color:"#4B3F91", theme:"자유시간 · 오로라#2", date:"9/12 (토)", iso:"2026-09-12", stops:[
      { t:"11:00", name:"Kolaportið 벼룩시장", lat:64.148933, lng:-21.938775, cat:"쇼핑", move:"숙소에서 도보 18분, 또는 Stræto 버스 약 690 ISK(10분)", note:"토·일 11:00~17:00만 운영 · 입장 무료" },
      { t:"11:30", name:"Reykjavík Art Museum — Hafnarhús", lat:64.149139, lng:-21.940938, cat:"관광", move:"바로 옆 건물, 도보 1분", note:"입장료 2,550 ISK(성인) · Kjarvalsstaðir·Ásmundarsafn까지 24시간 공통 · 매일 10-17(목~22)" },
      { t:"12:30", name:"Harpa 산책", lat:64.150246, lng:-21.932280, cat:"관광", move:"도보 10분", note:"건축·공연장 · 내부 관람 무료" },
      { t:"13:00", name:"점심 — Bæjarins Beztu (대안: Old Harbour Hot Dogs)", lat:64.148188, lng:-21.937886, cat:"간식", move:"도보 9분", note:"Bæjarins Beztu(Tryggvagata 1) · 대안 Old Harbour Hot Dogs(Ægisgarður 2, 매일 11-20, 평이 더 조용하고 대기 적음)" },
      { t:"14:30", name:"Marshall House — Kling & Bang · Living Art Museum(Nýlistasafnið)", lat:64.156255, lng:-21.939150, cat:"관광", move:"도보 20분, 또는 버스(정확한 노선은 Klappið 앱 확인, 약 690 ISK)", note:"토요일 12:00~18:00 · 입장 무료(3개 갤러리 모두)" },
      { t:"16:30", name:"자유시간", lat:64.156255, lng:-21.939150, cat:"이동", note:"근처 산책하며 여유있게" },
      { t:"17:30", name:"귀가길에 Vínbúðin에서 맥주 구매", lat:64.147678, lng:-21.939615, cat:"쇼핑", move:"Marshall House에서 도보 25분(귀가 방향), 또는 버스", note:"토요일 영업시간은 사전 확인 권장(보통 11-18)" },
      { t:"18:00", name:"숙소 도착, 저녁은 집에서", lat:64.1437875, lng:-21.9126406, cat:"이동", move:"도보 12분" },
    ...
    { id:4, color:"#26617F", theme:"자유시간 · 오로라 재도전", date:"9/13 (일)", iso:"2026-09-13", stops:[
      { t:"11:00", name:"국립미술관 (대안: Kjarvalsstaðir)", lat:64.144157, lng:-21.938863, cat:"관광", move:"아침은 집에서 먹고 출발 · 숙소에서 도보 20분", note:"국립미술관 입장료 약 1,700 ISK(전시별 상이) · 매일 10-17 / 대안 Kjarvalsstaðir(Flókagata 24, 숙소서 도보 9분로 더 가까움, 2,550 ISK, Hafnarhús 티켓과 별도)" },
      { t:"12:00", name:"Reykjavík Roasters 커피", lat:64.1436111, lng:-21.9266667, cat:"카페", move:"도보 12분(국립미술관 기준) · Kjarvalsstaðir 선택 시 도보 25분", note:"매일 7:00~17:00 · 자가배전" },
      { t:"12:30", name:"Braud & Co에서 빵 구매 (내일 비행기용)", lat:64.1440791, lng:-21.9259781, cat:"빵집", move:"도보 3분, 바로 근처", note:"매일 6:30~17:00 · 시나몬번 · 04:00 출발이라 미리 사두면 편함" },
      { t:"16:30", name:"자유시간 — 짐 미리 싸두기", lat:64.1437875, lng:-21.9126406, cat:"이동", move:"도보 15분, 귀가", note:"오늘 밤 투어 끝나고 바로 04:00 Flybus라 지금 다 싸두는 게 안전 · 저녁도 집에서" },
      { t:"19:30", name:"Skúli Craft Bar에서 맥주 한잔", lat:64.147554, lng:-21.941615, cat:"나이트라이프", move:"도보 20분, 또는 버스 약 690 ISK", note:"매일 12:00~23:00(목~토 ~01:00) · 아이슬란드 크래프트 맥주 전문, 테이스팅 플라이트 추천" },
      { t:"21:30~약02:00", name:"오로라 투어 (Day1 취소분 재예약)", lat:64.1437875, lng:-21.9126406, cat:"오로라", note:"⚠️ 투어 종료~04:00 Flybus 픽업까지 휴식시간이 약 2시간뿐 · 짐은 미리 다 싸두고 나가기" },
  ...
  food: [
    ...
    { n:"National Gallery of Iceland", c:"관광", lat:64.144157, lng:-21.938863, r:4.2, h:"매일 10:00~17:00", m:"기획전 중심 · House of Collections 동시 입장 · 입장료 약 1,700 ISK" },
    { n:"Reykjavík Art Museum (Kjarvalsstaðir)", c:"관광", lat:64.137915, lng:-21.913477, r:4.4, h:"매일 10:00~17:00", m:"Klambratún 공원 안 · Kjarval 상설전 · 입장료 2,550 ISK(3개 지점 공통) · 카페 평 좋음" },
