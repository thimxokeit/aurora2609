...
var DATA = {
  days: [
    { id:1, color:"#173355", theme:"레이캬비크 도착", date:"9/10 (목)", iso:"2026-09-10", stops:[
      ...
      { t:"12:30", name:"The World of Icelandic Music", lat:64.149909, lng:-21.932813, cat:"관광", note:"매일 10:00~20:00 · 아이슬란드 음악사 인터랙티브 전시, Harpa 근처" },
    ...
    { id:4, color:"#26617F", theme:"자유시간 · 오로라 재도전", date:"9/13 (일)", iso:"2026-09-13", stops:[
      ...
      { t:"13:00", name:"Reykjavík Art Museum — Hafnarhús", lat:64.149139, lng:-21.940938, cat:"관광", note:"일요일 10:00~17:00 · 컨템포러리 아트, Erró 상설전" },
      { t:"15:00", name:"국립미술관 (대안: Saga Museum)", lat:64.144157, lng:-21.938863, cat:"관광", note:"매일 10:00~17:00 · 대안: Saga Museum(Grandagarður 2, 바이킹 역사 체험형, 매일 10-17)" },
      { t:"16:30", name:"자유시간 — 짐 미리 싸두기", lat:64.1437875, lng:-21.9126406, cat:"이동", note:"오늘 밤 투어 끝나고 바로 04:00 Flybus라 지금 다 싸두는 게 안전" },
      { t:"18:00", name:"저녁 — Vínyl Bistro", lat:64.144966, lng:-21.922359, cat:"식사", note:"비건 전문 · 레코드 인테리어" },
      { t:"19:30", name:"Skúli Craft Bar에서 맥주 한잔", lat:64.147554, lng:-21.941615, cat:"나이트라이프", note:"매일 12:00~23:00(목~토 ~01:00) · 아이슬란드 크래프트 맥주 전문, 테이스팅 플라이트 추천" },
