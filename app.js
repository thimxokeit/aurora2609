...
var DATA = {
  days: [
    { id:1, color:"#173355", theme:"레이캬비크 도착", date:"9/10 (목)", iso:"2026-09-10", stops:[
      ...
      { t:"09:00", name:"BSÍ 짐 보관함(coin locker) 이용", lat:64.1372475, lng:-21.9349827, cat:"이동", note:"체크인 전이라 짐 맡기고 움직이기 · 카드결제 가능" },
      { t:"09:30", name:"Reykjavík Roasters 커피", lat:64.1436111, lng:-21.9266667, cat:"카페", note:"매일 7:00~17:00 · 자가배전 · 시내 중심" },
      { t:"10:30", name:"Hallgrímskirkja 주변 산책", lat:64.1420229, lng:-21.9265494, cat:"관광", note:"매일 10:00~17:00" },
      { t:"11:00", name:"Hallgrímskirkja 전망대(종탑)", lat:64.1420229, lng:-21.9265494, cat:"관광", note:"유료 · 엘리베이터+계단 · 시내 360도 전망" },
      { t:"11:45", name:"Skólavörðustígur 거리 산책", lat:64.144495, lng:-21.930386, cat:"쇼핑", note:"무지개 거리 · 상점·카페 밀집 · 점심은 이미 먹었으니 가볍게" },
      { t:"13:00", name:"Mokka Kaffi에서 휴식", lat:64.146003, lng:-21.932405, cat:"카페", note:"매일 9:00~18:00 · 1958년부터, 레이캬비크에서 가장 오래된 카페 · 와플 유명" },
      { t:"14:00", name:"숙소 체크인 (Bríetartún 18)", lat:64.1437875, lng:-21.9126406, cat:"이동", note:"BSÍ에서 짐 찾아서 이동" },
      { t:"15:00", name:"Reykjavík Art Museum — Hafnarhús", lat:64.149139, lng:-21.940938, cat:"관광", note:"매일 10:00~17:00(목 ~22:00) · 컨템포러리 아트, Erró 상설전" },
      { t:"16:30", name:"Braud & Co에서 티타임", lat:64.1440791, lng:-21.9259781, cat:"빵집", note:"매일 6:30~17:00 · 시나몬번" },
      { t:"18:30", name:"저녁 — Café Loki", lat:64.142403, lng:-21.928852, cat:"식사", note:"매일 8:00~22:00 · 램수프 추천, 갑각류 메뉴는 피하기" },
    ...
    { id:2, color:"#2A6F8E", theme:"빙하투어 (남부해안)", date:"9/11 (금)", iso:"2026-09-11", stops:[
      ...
      { t:"10:50", name:"키르큐베야르클라우스트르 — 점심 45분", lat:63.789024, lng:-18.053116, cat:"식사", note:"버스·코치 110분 이동 후 점심" },
      { t:"13:10", name:"Jökulsárlón 빙하라군 & 다이아몬드비치 (1.5시간)", lat:64.078446, lng:-16.230554, cat:"관광", note:"유빙·물범 관찰 · 보트크루즈 옵션(추가요금) · 이동시간은 추정" },
      { t:"17:10", name:"비크이뮈르달 — 저녁 45분", lat:63.417650, lng:-18.997440, cat:"식사", note:"이동시간은 추정" },
      { t:"18:50", name:"Seljalandsfoss — 사진촬영 30분", lat:63.615623, lng:-19.988569, cat:"관광", note:"폭포 뒤로 걸어들어갈 수 있음 · 우비 필요 · 이동시간은 추정" },
      { t:"21:10", name:"투어 종료, 숙소 복귀", lat:64.1437875, lng:-21.9126406, cat:"이동", note:"버스·코치 110분 · 왕복 약 14시간" }
    ]},
    { id:3, color:"#4B3F91", theme:"자유시간 · 오로라#2", date:"9/12 (토)", iso:"2026-09-12", stops:[
      ...
      { t:"16:00", name:"Harpa 산책", lat:64.150246, lng:-21.932280, cat:"관광", note:"건축·공연장 · 무료 관람 가능" },
      { t:"18:30", name:"저녁 — Messinn", lat:64.146583, lng:-21.937727, cat:"식사", note:"매일 11:30~22:00 · 예약 권장 · 갑각류 대신 생선요리로" },
      { t:"21:00~02:00", name:"오로라 투어 #2", lat:64.1437875, lng:-21.9126406, cat:"오로라", note:"Northern Lights Guided Tour · 픽업 장소 바우처 확인" }
    ]},
    { id:4, color:"#26617F", theme:"자유시간", date:"9/13 (일)", iso:"2026-09-13", stops:[
      { t:"11:00", name:"늦은 브런치 — Sandholt", lat:64.145032, lng:-21.926340, cat:"카페", note:"매일 7:30~18:00 · 전날 새벽 2시 취침이라 여유있게" },
      { t:"14:00", name:"국립미술관 (대안: Saga Museum)", lat:64.144157, lng:-21.938863, cat:"관광", note:"매일 10:00~17:00 · 대안: Saga Museum(Grandagarður 2, 바이킹 역사 체험형, 매일 10-17)" },
      { t:"16:00", name:"자유시간 — 짐 정리·휴식", lat:64.1437875, lng:-21.9126406, cat:"이동", note:"내일 새벽 이동 대비" },
      { t:"18:00", name:"저녁 — Vínyl Bistro", lat:64.144966, lng:-21.922359, cat:"식사", note:"비건 전문 · 레코드 인테리어" },
      { t:"20:00", name:"Húrra 라이브뮤직 체크", lat:64.146812, lng:-21.931978, cat:"나이트라이프", note:"당일 라인업은 별도 확인 필요" },
    ...
    { id:5, color:"#7A4E97", theme:"아이슬란드 → 헬싱키", date:"9/14 (월)", iso:"2026-09-14", stops:[
      ...
      { t:"17:00", name:"Allas Sea Pool (대안: Kauppatori 마켓광장 산책)", lat:60.167100, lng:24.957162, cat:"휴식", note:"월~금 6:30~21:00 · 바다 사우나+수영장, 장거리 이동 뒤 휴식 · 대안: 수영 대신 옆의 마켓광장·항구 산책" },
  ...
  food: [
    ...
    { n:"National Gallery of Iceland", c:"관광", lat:64.144157, lng:-21.938863, r:4.2, h:"매일 10:00~17:00", m:"기획전 중심 · House of Collections 동시 입장" },
