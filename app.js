...
var DATA = {
  days: [
    ...
    { id:6, color:"#1F5AA8", theme:"헬싱키 도보 투어 코스", date:"9/15 (화)", iso:"2026-09-15", stops:[
      ...
      { t:"13:30", name:"Oodi 3층 카페에서 커피", lat:60.173683, lng:24.937919, cat:"카페", move:"같은 건물, 이동 없음", note:"도서관 최상층 · 시내 전망 · Kallio는 짧게만 둘러볼 거라 커피는 여기서" },
      { t:"13:50", name:"Kiasma 컨템포러리 아트뮤지엄", lat:60.171591, lng:24.936864, cat:"관광", move:"도보 5분", note:"화요일 10:00~20:00 · 월요일 휴관 · 입장료 €21(할인)~23(일반) · 현재 사미족 미술전 등 3개 전시 동시 진행" },
      { t:"14:35", name:"S-market · Moomin Shop에서 선물 쇼핑", lat:60.170841, lng:24.939092, cat:"쇼핑", move:"도보 2분", note:"S-market(24시간): 자일리톨 껌·치약, Fazer 초콜릿, 살미아키 민트 · Moomin Shop(도보 1분 추가): 머그컵·에코백 — 팀 선물용" },
      { t:"15:20", name:"🚋 Kallio로 이동", lat:60.184324, lng:24.949357, cat:"이동", move:"트램 약 15분 (여기서 탭한 티켓으로 80분 이내 환승 무료)", note:"돌아올 때 이 티켓 그대로 쓰려면 16:40 전에 귀가 트램 탑승" },
      { t:"15:35", name:"Kallio 교회 · 골목 산책", lat:60.184324, lng:24.949357, cat:"관광", move:"짧게 둘러보고 바로 이동", note:"언덕 위 랜드마크 · 빨리 돌아올 거라 카페 없이 교회·골목만 20~30분" },
      { t:"16:15", name:"🚋 남쪽으로 이동 (같은 티켓)", lat:60.184324, lng:24.949357, cat:"이동", move:"트램 약 20분", note:"15:20 탭 기준 80분 이내(~16:40) 탑승" },
      { t:"16:45", name:"Kaivopuisto 공원 산책", lat:60.155703, lng:24.955690, cat:"관광", move:"숙소에서 도보 12분권 · 바로 산책", note:"24시간 무료 · 바다 전망 공원 · 숙소서 가까운데 아직 안 가본 곳" },
      { t:"18:00", name:"Café Ursula에서 커피", lat:60.155195, lng:24.960609, cat:"카페", move:"공원 안, 도보 6분", note:"바다 전망 좌석 · 담요 대여 가능 · 가격대는 살짝 있는 편" },
      { t:"19:20", name:"숙소로 이동", lat:60.160012, lng:24.947378, cat:"이동", move:"도보 15분" },
      { t:"20:00", name:"저녁은 집에서", lat:60.160012, lng:24.947378, cat:"식사", note:"필요하면 Alepa Ullanlinna(도보 3분, ~23시)에서 장보기" },
    ...
    { id:7, color:"#4E6E8A", theme:"헬싱키 → 한국", date:"9/16 (수)", iso:"2026-09-16", stops:[
      ...
      { alt:true, t:"", name:"건축·디자인 박물관", lat:60.163032, lng:24.946391, cat:"관광", note:"수요일 11:00~18:00 · 숙소서 도보 3분 · 입장료 €22(Design Museum·건축박물관 각각 별도) · 가구·산업디자인 실물 위주라 Kiasma보다 직관적 · 단 11시 개관이라 1시간만 가능" },
  ...
  food: [
    ...
    { n:"Beard Park Cafe", c:"카페", lat:60.184303, lng:24.951871, r:4.8, h:"월 9-19, 화~금 8:30~19:00, 토·일 9-18", m:"카페+이발소 콘셉트 · Kallio 교회 바로 앞 · 연어샌드위치·커피 평 좋음" },
    { n:"Kaivopuisto", c:"관광", lat:60.155703, lng:24.955690, r:4.5, h:"24시간", m:"바다 전망 공원 · 숙소 도보 12분 · 대사관 밀집 지역, 조용하고 산책 좋음" },
