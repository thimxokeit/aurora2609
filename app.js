...
var DATA = {
  days: [
    ...
    { id:5, color:"#7A4E97", theme:"아이슬란드 → 헬싱키", date:"9/14 (월)", iso:"2026-09-14", stops:[
      ...
      { t:"16:00", name:"숙소 체크인 (Korkeavuorenkatu 3)", lat:60.160012, lng:24.947378, cat:"이동", move:"🚆 공항열차 I/P → 중앙역 30분 (ABC권 €4.80) → 🚋 트램 10번 또는 도보 18분" },
      { t:"17:00", name:"Kauppatori 마켓광장 · 항구 산책", lat:60.167665, lng:24.953678, cat:"관광", move:"도보 11분", note:"야외 좌판 · 무료 · 옆에 Allas Sea Pool(수영복 대여 가능, ~21시)" },
      { t:"17:20", name:"Old Market Hall (Vanha kauppahalli)", lat:60.166164, lng:24.952819, cat:"관광", move:"도보 3분", note:"⏰월~토 8:00~18:00 · 1889년 목조 마켓홀 · 연어수프·순록 등 시식 가능" },
