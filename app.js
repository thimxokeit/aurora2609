...
var DATA = {
  days: [
    ...
    { id:4, color:"#26617F", theme:"자유시간 · 오로라 재도전", date:"9/13 (일)", iso:"2026-09-13", stops:[
      ...
      { t:"14:15", name:"Reykjavík Roasters 커피", lat:64.1436111, lng:-21.9266667, cat:"카페", move:"도보 16분", note:"매일 7:00~17:00 · 자가배전" },
      { t:"14:45", name:"Braud & Co에서 빵 구매 (내일 비행기용)", lat:64.1440791, lng:-21.9259781, cat:"빵집", move:"도보 3분", note:"매일 6:30~17:00 · 대안: Sandholt(~18:00) / BakaBaka(~22:00)" },
      { t:"15:45", name:"Grótta 등대 (Seltjarnarnes)", lat:64.163889, lng:-22.021389, cat:"관광", move:"🚌 11번 버스 (카드 만료 → 편도 690 ISK) + 도보 15분", note:"⚠️ 조수에 따라 둑길이 잠기니 물때 확인 · 무료 · 바람 강하니 방한 단단히 · Kvika 족욕탕 근처" },
      { t:"18:00", name:"숙소 복귀", lat:64.1437875, lng:-21.9126406, cat:"이동", move:"🚌 11번 버스 (690 ISK)" },
      { t:"19:00", name:"숙소에서 저녁", lat:64.1437875, lng:-21.9126406, cat:"식사", note:"SPAR에서 산 재료로 간단히" },
      { t:"20:00", name:"짐 챙기기", lat:64.1437875, lng:-21.9126406, cat:"이동", note:"04:00 Flybus까지 그대로 들고 나갈 상태로" },
  ...
  food: [
    ...
    { n:"Grótta 등대", c:"관광", lat:64.163889, lng:-22.021389, r:4.7, h:"24시간 (둑길은 조수 영향)", m:"Seltjarnarnes 반도 끝 · 11번 버스 · 오로라·일몰 명소 · Kvika 족욕탕 근처" },
