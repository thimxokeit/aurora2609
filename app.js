...
var DATA = {
  days: [
    ...
    { id:3, color:"#4B3F91", theme:"자유시간 · 오로라#2", date:"9/12 (토)", iso:"2026-09-12", stops:[
      { t:"10:00", name:"Reykjavík Art Museum — Kjarvalsstaðir ⭐시티카드 수령", lat:64.137915, lng:-21.913477, cat:"관광", move:"숙소에서 도보 9분 (수령처 중 제일 가까움, 버스 안 타도 됨)", note:"⭐온라인 바우처 → 실물 카드 교환 (매일 10-17) · 여기서부터 48시간 카운트 → 일요일 밤까지 커버 · 입장료 2,550 ISK 카드로 무료 · Klambratún 공원 안, Kjarval 상설전" },
      { t:"11:15", name:"Reykjavík Art Museum — Hafnarhús", lat:64.149139, lng:-21.940938, cat:"관광", move:"도보 30분 → 🚌 버스 이용 (이제부터 시티카드로 무료)", note:"입장료 2,550 ISK도 카드 커버 · 매일 10-17(목~22) · Erró 상설전" },
      { t:"12:15", name:"Kolaportið 벼룩시장", lat:64.148933, lng:-21.938775, cat:"쇼핑", move:"바로 옆 건물, 도보 1분", note:"토·일 11:00~17:00만 운영 · 입장 무료" },
      { t:"13:00", name:"점심 — Bæjarins Beztu (대안: Old Harbour Hot Dogs)", lat:64.148188, lng:-21.937886, cat:"간식", move:"도보 3분 (10분 미만이라 걸어감)", note:"Bæjarins Beztu(Tryggvagata 1) · 대안 Old Harbour Hot Dogs(Ægisgarður 2, 매일 11-20, 평이 더 조용하고 대기 적음)" },
      { t:"14:30", name:"Marshall House — Kling & Bang · Living Art Museum(Nýlistasafnið)", lat:64.156255, lng:-21.939150, cat:"관광", move:"도보 20분 → 🚌 버스 이용 (시티카드 무료)", note:"토요일 12:00~18:00 · 입장 무료(3개 갤러리 모두)" },
      { t:"16:30", name:"자유시간", lat:64.156255, lng:-21.939150, cat:"이동", note:"근처 산책하며 여유있게" },
      { t:"17:30", name:"귀가길에 Vínbúðin에서 맥주 구매", lat:64.147678, lng:-21.939615, cat:"쇼핑", move:"Marshall House에서 도보 25분(귀가 방향) → 🚌 버스 이용 (시티카드 무료)", note:"⚠️ 일요일 휴무라 오늘(토) 꼭 사둘 것 · 토요일 보통 11-18 마감이니 시간 확인" },
      { t:"18:00", name:"숙소 도착, 저녁은 집에서", lat:64.1437875, lng:-21.9126406, cat:"이동", move:"도보 12분 → 🚌 버스 이용 (시티카드 무료)" },
    ...
    { id:4, color:"#26617F", theme:"자유시간 · 오로라 재도전", date:"9/13 (일)", iso:"2026-09-13", stops:[
      { t:"10:00", name:"National Museum of Iceland", lat:64.141615, lng:-21.948578, cat:"관광", move:"아침은 집에서 · 숙소에서 도보 28분 → 🚌 버스 이용 (시티카드 무료)", note:"10:00 오픈 시간에 맞춰 도착 · 입장료 약 2,500 ISK · 시티카드 커버 · 1~1.5시간 소요" },
      { t:"11:30", name:"국립미술관 (National Gallery)", lat:64.144157, lng:-21.938863, cat:"관광", move:"도보 8분 (10분 미만이라 걸어감)", note:"입장료 약 1,700 ISK · 매일 10-17 · 시티카드 커버" },
      { t:"12:45", name:"Reykjavík Roasters 커피", lat:64.1436111, lng:-21.9266667, cat:"카페", move:"도보 12분 → 🚌 버스 이용 (시티카드 무료)", note:"매일 7:00~17:00 · 자가배전" },
      { t:"13:15", name:"Braud & Co에서 빵 구매 (내일 비행기용)", lat:64.1440791, lng:-21.9259781, cat:"빵집", move:"도보 3분, 바로 옆", note:"매일 6:30~17:00 · 커피 마신 김에 바로 옆이라 여기서 미리 사두기 · 대안: Sandholt(Laugavegur 36, 도보 3분, ~18:00) / BakaBaka(Bankastræti 2, ~22:00, 가장 늦게까지)" },
      { t:"14:00", name:"The Settlement Exhibition (정착 전시관)", lat:64.147399, lng:-21.942501, cat:"관광", move:"도보 15분 → 🚌 버스 이용 (시티카드 무료)", note:"입장료 약 2,500 ISK · 매일 10-17 · 시티카드 커버 · 실제 발굴된 1000년 전 롱하우스 유적 위에 지은 전시관" },
      { t:"15:30", name:"숙소 복귀 · 휴식", lat:64.1437875, lng:-21.9126406, cat:"이동", move:"도보 25분 → 🚌 버스 이용 (시티카드 무료)" },
