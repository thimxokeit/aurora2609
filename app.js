...
var DATA = {
  days: [
    ...
    { id:6, color:"#1F5AA8", theme:"헬싱키 도보 투어 코스", date:"9/15 (화)", iso:"2026-09-15", stops:[
      ...
      { t:"13:45", name:"Kiasma 컨템포러리 아트뮤지엄", lat:60.171591, lng:24.936864, cat:"관광", move:"도보 5분", note:"화요일 10:00~20:00 · 월요일 휴관" },
      { t:"14:15", name:"S-market · Moomin Shop에서 선물 쇼핑", lat:60.170841, lng:24.939092, cat:"쇼핑", move:"도보 2분", note:"S-market(24시간): 자일리톨 껌·치약, Fazer 초콜릿, 살미아키 민트 · Moomin Shop(도보 1분 추가): 머그컵·에코백 — 팀 선물용" },
      { t:"15:00", name:"🚋 Kallio로 이동", lat:60.184324, lng:24.949357, cat:"이동", move:"트램 약 15분 (여기서 탭한 티켓으로 80분 이내 환승 무료)", note:"돌아올 때 이 티켓 그대로 쓰려면 16:20 전에 귀가 트램 탑승" },
      { t:"15:15", name:"Kallio 교회 · Beard Park Cafe", lat:60.184303, lng:24.951871, cat:"카페", move:"교회 바로 앞, 도보 1분", note:"카페 화~금 8:30~19:00 · 카페+이발소 콘셉트, 연어샌드위치·커피 평 좋음(4.8) · 교회는 언덕 위 랜드마크" },
      { t:"16:00", name:"Kallio 골목 구경 (레코드숍 등)", lat:60.181566, lng:24.950665, cat:"쇼핑", move:"도보 5분", note:"화요일 11-18 · Black And White Records, Stupido Market Kallio 등 · 사지 않고 구경만 해도 재밌는 동네" },
      { t:"17:00", name:"🚋 남쪽으로 이동", lat:60.184324, lng:24.949357, cat:"이동", move:"트램 약 20분 (새 티켓)", note:"80분 창은 이미 지났으니 새로 탭" },
      { t:"17:30", name:"Kaivopuisto 공원 산책", lat:60.155703, lng:24.955690, cat:"관광", move:"숙소에서 도보 12분권 · 바로 산책", note:"24시간 무료 · 바다 전망 공원 · 숙소서 가까운데 아직 안 가본 곳" },
      { t:"18:30", name:"Café Ursula에서 커피", lat:60.155195, lng:24.960609, cat:"카페", move:"공원 안, 도보 6분", note:"바다 전망 좌석 · 담요 대여 가능 · 가격대는 살짝 있는 편" },
      { t:"19:40", name:"숙소로 이동", lat:60.160012, lng:24.947378, cat:"이동", move:"도보 15분" },
