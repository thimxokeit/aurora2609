...
var DATA = {
  days: [
    ...
    { id:3, color:"#4B3F91", theme:"자유시간 · 오로라#2", date:"9/12 (토)", iso:"2026-09-12", stops:[
      { t:"11:00", name:"Kolaportið 벼룩시장", lat:64.148933, lng:-21.938775, cat:"쇼핑", move:"숙소에서 도보 18분 → 🚌 버스 이용 (시티카드 무료)", note:"토·일 11:00~17:00만 운영 · 입장 무료" },
      ...
      { t:"12:45", name:"점심 — Bæjarins Beztu (대안: Old Harbour Hot Dogs)", lat:64.148188, lng:-21.937886, cat:"간식", move:"도보 3분 (10분 미만이라 걸어감)", note:"Bæjarins Beztu(Tryggvagata 1) · 대안 Old Harbour Hot Dogs(Ægisgarður 2, 매일 11-20, 평이 더 조용하고 대기 적음)" },
      ...
      { t:"17:30", name:"귀가길에 Vínbúðin에서 맥주 구매", lat:64.147678, lng:-21.939615, cat:"쇼핑", move:"Marshall House에서 도보 25분(귀가 방향) → 🚌 버스 이용 (시티카드 무료)", note:"토요일 영업시간은 사전 확인 권장(보통 11-18)" },
    ...
    { id:4, color:"#26617F", theme:"자유시간 · 오로라 재도전", date:"9/13 (일)", iso:"2026-09-13", stops:[
      ...
      { t:"14:00", name:"Reykjavík Art Museum — Kjarvalsstaðir", lat:64.137915, lng:-21.913477, cat:"관광", move:"도보 16분 → 🚌 버스 이용 (시티카드 무료)", note:"입장료 2,550 ISK · 매일 10-17 · 시티카드 커버 · Klambratún 공원 안, Kjarval 상설전" },
      { t:"15:30", name:"숙소 복귀 · 휴식", lat:64.1437875, lng:-21.9126406, cat:"이동", move:"도보 9분 (10분 미만이라 걸어감)" },
