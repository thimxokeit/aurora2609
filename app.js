...
var DATA = {
  days: [
    ...
    { id:6, color:"#1F5AA8", theme:"헬싱키 도보 투어 코스", date:"9/15 (화)", iso:"2026-09-15", stops:[
      ...
      { t:"16:50", name:"Moomin Shop Forum", lat:60.169307, lng:24.938046, cat:"쇼핑", move:"도보 6분", note:"매장별 상이, 대체로 매일 10-20 · 머그컵·에코백 등 캐릭터 굿즈 — 팀 선물용" },
      { t:"17:10", name:"S-market Sokos", lat:60.170841, lng:24.939092, cat:"쇼핑", move:"도보 2분, 바로 근처", note:"24시간 · 자일리톨 껌·치약, Fazer 초콜릿, 살미아키 민트 — 팀 선물용" },
